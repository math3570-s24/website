...
- `r emo::ji('sunglasses')` Implement R/Python programs *without* installing R/Python and the IDE in your laptop! 
...
- *Step 3*: **Free^[You are encouraged to choose Student plan for 75 hours usage per month.] > Sign Up**. Please sign up with *GitHub* if you have one or use your *Marquette email address*.
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics("images/03-posit/posit-free-plan.png")
```
:::
::::
...
::: notes
Go to D2l to send Posit Cloud inivation
