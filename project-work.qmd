...
-   **ggplot3**: Arik Zintel, Iris Murphy, Yesenia Tavizon, Lauren Barrile
    ...
    + [R package] [Leaflet: An Introduction to Geographic Data Visualization](https://math3570-s24.github.io/website/documents/proposal_ggplot3.pdf)

-   **Ctrl + Alt + Elite**: Mia Kwiatkoski, Sienna Ifill, Mridula Geddam, Bridget Clark

    + [R package] [Do you Believe in Magick?](https://math3570-s24.github.io/website/documents/proposal_CtrlAltDelete.pdf)

-   **Big Meta Watchers**: Miguel Basurto, Nicholas Paulick, Christopher Purney, Darius Dahl

    + [Data analysis; Python package] [How to Use Data Science in Real-Life](https://math3570-s24.github.io/website/documents/proposal_bigmeta.pdf)

-   **Win Rs**: Allan Akkathara, Michael Hankins, Katy Carter, Maddie Flint

    + [Data analysis] [How You Can Sleep Better: A Data Analysis](https://math3570-s24.github.io/website/documents/proposal_WinR.pdf)
    
    
-   **Red Pandas**: Michael Gephart, Rich Lukas, Candice Watson, Fike Carter

    + [R package] [RGL: 3D Visualization of Trails](https://math3570-s24.github.io/website/documents/proposal_RedPandas.pdf)

-   **Data Dawgs**: Patrick Dunleavy, Alex Kusek, Arianna Smith, Luke Baumer

    + [Data analysis] [Datadawgs Take on College](https://math3570-s24.github.io/website/documents/proposal_datadawg.pdf)
