...
- **Meeting**. Schedule a group meeting with Dr. Yu discussing your project. Please book a time slot in the [Excel form](https://marq-my.sharepoint.com/:x:/g/personal/cheng-han_yu_marquette_edu/ETtTWF_3hkpOnAVrdXendnYB1jHd4eIR2xfSPhXD9xcJ_g?e=uGqyYg).

- **Presentation**. You will be presenting your project on [**Monday, 5/6 10:30 AM - 12:30 PM**]{.red}.

- **Materials**. Please share your *entire work* (slides, code, data, etc) by [**Monday, 5/6 11:59 PM**]{.red}.
...
- Each group presentation should be between **14 and 15 minute** long, followed by **1 to 2 minute** Q&A. If your presentation is too short or too long, _every one of you loses 3 points_ of your project grade.
...
- If you, as a group, don't ask a question when you should, _every one of you loses 3 points_ of your project grade.
...
- you need to 
    ...
    * explain how to use the functions in the packages by providing data science examples with some real data set. Please _don't use the toy examples_ in the package documentation.
...
- Table 1 shows your possible performance grade. For example, if your group finish in fourth place and you are elected as the best contributor, your grade is 92. If your group finish in second place, and you are not the best contributor, you get 94.

- Your project grade will be 
\quote{\texttt{project grade = performance grade - points lost due to violation of policy}}

```{r, echo=FALSE}
# library(tidyverse)
first_ind <- c(100, 98, 95, 92, 89, 87, 85)
other_ind <- c(97, 94, 91, 88, 86, 84, 82)
# grade <- tibble(first_ind, other_ind)
# grade <- as.data.frame(grade)
grade <- data.frame(first_ind, other_ind)
rownames(grade) <- paste("Group Rank", 1:7)
...
- __No two groups receive the same ranking__. If you give two or more groups some points, you still need to give them a different ranking, deciding which teams deserve a higher ranking according to your preference.
